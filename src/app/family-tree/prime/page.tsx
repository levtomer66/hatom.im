...
const FamilyTreePrime = dynamic(() => import('@/components/FamilyTreePrime'), {
  ssr: false,
});

export default function FamilyTreePrimePage() {
  return (
      ...
      <nav className="bg-amber-800 text-white p-4 shadow-md">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex space-x-4">
            ...
            <Link href="/family-tree/prime" className="font-bold underline">
              PrimeReact View
            </Link>
          </div>
        </div>
